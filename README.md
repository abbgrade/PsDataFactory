...
Install PsDataFactory from [PowerShell Gallery](https://www.powershellgallery.com/packages/PsDataFactory) using a PowerShell command line:
...
[![.github/workflows/build-validation.yml](https://github.com/abbgrade/PsDataFactory/actions/workflows/build-validation.yml/badge.svg?branch=develop)](https://github.com/abbgrade/PsDataFactory/actions/workflows/build-validation.yml)
